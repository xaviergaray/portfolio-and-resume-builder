...
\header{Work Experience}
                ...
                \textbf{Amazon} \hfill New York, NY\\
                \textit{Software Development Engineer, Intern} \hfill September 2025 - December 2025\\
                \vspace{-1mm}
                \begin{itemize} \itemsep 1pt
                
                \item Designed and built a React ad performance analytics dashboard used by stakeholders to analyze campaign effectiveness across creative metadata dimensions
                \item Architected an end-to-end AWS analytics backend using Redshift Serverless, API Gateway, and Lambda for asynchronous SQL access to production data, with AWS Glue jobs to migrate datasets from S3 into Redshift\end{itemize}
